function Projetos() {
    return (
        <section className="w-full px-4 py-12 flex flex-col items-center">
            ...
            <div className="max-w-6xl w-full flex flex-col sm:flex-row justify-between items-start sm:items-center mb-12">
                <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl w-full">
                ...
                <div className="p-4 flex flex-col items-start group">
                    ...
                    <h3 className="text-lg text-black font-semibold mb-2">Karona</h3>
                    <p className="text-sm text-black mb-4">03 Junho 2025</p>
                    <a href="https://github.com/grupo5-turma-java-81/grupo5-turma-java-81-Aplicativo_De_Caronas_Compartilhadas_frontend" className="bg-black text-white py-2 px-4 rounded flex items-center gap-2 hover:bg-gray-800">
                        Acessar →
                    </a>
                </div>
                ...
                <div className="p-4 flex flex-col items-start group">
                    ...
                    <h3 className="text-lg text-black font-semibold mb-2">Fit Lab</h3>
                    <p className="text-sm text-black mb-4">05 Junho 2025</p>
                    <a href="https://github.com/Aplicativo-Fitness-Personalizado/Aplicativo-Fitness-Personalizado-Frontend" className="bg-black text-white py-2 px-4 rounded flex items-center gap-2 hover:bg-gray-800">
                        Acessar →
                    </a>
                </div>
                ...
                <div className="p-4 flex flex-col items-start group">
                    ...
                    <h3 className="text-lg text-black font-semibold mb-2">RH Corp</h3>
                    <p className="text-sm text-black mb-4">10 Junho 2025</p>
                    <a href="https://aplicativo-sistema-de-rh-aplicativo-iota.vercel.app/" className="bg-black text-white py-2 px-4 rounded flex items-center gap-2 hover:bg-gray-800">
                        Acessar →
                    </a>
                </div>
